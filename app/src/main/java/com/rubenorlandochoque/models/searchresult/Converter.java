...
//
//     SearchResult data = Converter.fromJsonString(jsonString);
...
public class Converter {
    ...
    public static SearchResult fromJsonString(String json) throws IOException {
        return getObjectReader().readValue(json);
    }

    public static String toJsonString(SearchResult obj) throws JsonProcessingException {
    ...
    private static void instantiateMapper() {
        ...
        reader = mapper.readerFor(SearchResult.class);
        writer = mapper.writerFor(SearchResult.class);
    }
