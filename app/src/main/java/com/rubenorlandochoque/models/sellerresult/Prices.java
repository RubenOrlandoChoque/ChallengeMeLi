...
public class Prices {
    ...
    public List<ReferencePrice> getReferencePrices() { return referencePrices; }
    @JsonProperty("reference_prices")
    public void setReferencePrices(List<ReferencePrice> value) { this.referencePrices = value; }
